...
- Create block2 folder and DS-1 sub-folder
- Under DS-1 sub-folder store input(my prompt) in block2_DS1_input
- Under DS-1 sub-folder store your results output in block2_DS1_output
