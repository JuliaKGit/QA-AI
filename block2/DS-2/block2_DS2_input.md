...
- Create block2 folder and DS-2 sub-folder
- Under DS-2 sub-folder store input(my prompt) in block2_DS2_input
- Under DS-2 sub-folder store your results output in block2_DS2_output
