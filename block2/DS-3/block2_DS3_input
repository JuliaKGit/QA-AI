...
- Create DS-3 sub-folder under block2 folder
- Under DS-3 sub-folder store input(my prompt) in block2_DS3_input
- Under DS-3 sub-folder store your results output in block2_DS3_output
